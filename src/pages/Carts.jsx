...
export default function Carts() {
  return (
    <div className="space-y-6">
      ...
      className="rounded-2xl border border-dashed border-brand-200 dark:border-white/[0.08] bg-white/40 dark:bg-coal-800/40 p-12 text-center flex flex-col items-center justify-center min-h-[300px]">
        <motion.div 
                  whileHover={{ rotate: 10, scale: 1.1 }}
          transition={{ type: "spring", stiffness: 300, damping: 15 }}
        className="w-14 h-14 rounded-2xl bg-brand-50 dark:bg-coal-600 flex items-center justify-center text-brand-400 dark:text-content-muted mb-4 border border-brand-100 dark:border-white/[0.06]">
