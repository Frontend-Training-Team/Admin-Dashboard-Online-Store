...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    {
      title: 'Top Product',
      value: `${data?.dashboard?.topProducts[0].name || 0}`,
      desc: '53 Units Sold',
  ...
  const bestSellers = [
    {
      name: `${data?.dashboard?.topProducts[0].name || 0}`,
    ...
    {
      name: `${data?.dashboard?.topProducts[1].name || 0}`,
      details: `${data?.dashboard?.topProducts[1].totalSold || 0} Units Sold • $${data?.dashboard?.topProducts[0].revenue || 0} `,
      img: `${data?.dashboard?.topProducts[1].image || imgUser}`
    },
    {
      name: `${data?.dashboard?.topProducts[2].name || 0}`,
      details: `${data?.dashboard?.topProducts[2].totalSold || 0} Units Sold • $${data?.dashboard?.topProducts[0].revenue || 0} `,
      img: `${data?.dashboard?.topProducts[2].image || imgUser}`
    },
    {
      name: `${data?.dashboard?.topProducts[3].name || 0}`,
      details: `${data?.dashboard?.topProducts[3].totalSold || 0} Units Sold • $${data?.dashboard?.topProducts[0].revenue || 0} `,
      img: `${data?.dashboard?.topProducts[3].image || imgUser}`
    },
    {
      name: `${data?.dashboard?.topProducts[4].name || 0}`,
      details: `${data?.dashboard?.topProducts[4].totalSold || 0} Units Sold • $${data?.dashboard?.topProducts[0].revenue || 0} `,
  ...
  const recentActivity = [
    {
      ...
      status: `${data?.dashboard?.recentOrders[0].status || 0}`,
