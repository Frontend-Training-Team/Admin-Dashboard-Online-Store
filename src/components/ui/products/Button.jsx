function Button({ variant = "primary", children, compact = false, disabled = false, ...rest }) {
  const styles = {
    primary:
      "bg-copper-500 hover:bg-[#b06f47] text-white font-medium shadow-xs",
    secondary:
      "bg-brand-50 hover:bg-brand-100 text-brand-800 border border-brand-200 dark:bg-coal-600 dark:hover:bg-[#262B34] dark:text-content-secondary dark:border-white/[0.08]",
  };
