            ...
            <tr key={idx} className="animate-pulse">
              ...
              <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                  <div className="h-9 w-9 rounded-full bg-gray-200/70 dark:bg-coal-700 shrink-0" />
                  <div className="space-y-1.5">
                    <div className="h-3.5 w-24 rounded bg-gray-200/70 dark:bg-coal-700" />
                    <div className="h-2.5 w-32 rounded bg-gray-200/40 dark:bg-coal-700/60" />
                  </div>
                </div>
              </td>
              <td className="px-6 py-4">
                <div className="h-3.5 w-20 rounded bg-gray-200/70 dark:bg-coal-700" />
              </td>
              <td className="px-6 py-4">
                <div className="h-6 w-20 rounded-full bg-gray-200/70 dark:bg-coal-700" />
              </td>
              <td className="px-6 py-4">
                <div className="space-y-1">
                  <div className="h-3.5 w-14 rounded bg-gray-200/70 dark:bg-coal-700" />
                  <div className="h-2.5 w-10 rounded bg-gray-200/40 dark:bg-coal-700/60" />
                </div>
              </td>
              <td className="px-6 py-4">
                <div className="h-4 w-24 rounded bg-gray-200/70 dark:bg-coal-700" />
              </td>
              <td className="px-6 py-4">
                <div className="h-8 w-16 rounded-xl bg-gray-200/70 dark:bg-coal-700" />
              </td>
            </tr>
          ))
        ) : orders.length === 0 ? (
