function StatCard({ title, value, desc, icon, color, borderLeft }) {
  return (
    <div className={`flex-1 p-4 sm:p-5 rounded-2xl bg-surface-cardLight dark:bg-[#12141A] 
    border border-brand-200/60 dark:border-[rgba(255,255,255,0.06)] border-l-[3px] ${borderLeft} shadow-sm shrink-0`}>
      ...
      <h3 className="text-2xl sm:text-3xl font-semibold text-brand-900 dark:text-[#F5F1EA] mt-2 sm:mt-2.5 truncate">
        {value}
      </h3>

      <p className="text-[11px] sm:text-xs text-brand-700/80 dark:text-[#8A8378] mt-1">
        {desc}
      </p>
