  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-gray-100 dark:border-[rgba(255,255,255,0.06)] bg-white dark:bg-[#12141A] shadow-sm">
                ...
                <tr key={index} className="animate-pulse dark:bg-[#1E2435]">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3.5">
                      ...
                      <div className="space-y-2">
                        <div className="h-4 w-28 rounded bg-gray-200/70 dark:bg-[#181B22]" />
                        <div className="h-3 w-40 rounded bg-gray-200/40 dark:bg-[#181B22]/60" />
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="h-4 w-16 rounded bg-gray-200/70 dark:bg-[#181B22]" />
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2.5">
                      <div className="h-9 w-9 rounded-xl bg-gray-200/70 dark:bg-[#181B22]" />
                      <div className="h-9 w-9 rounded-xl bg-gray-200/70 dark:bg-[#181B22]" />
                      <div className="h-9 w-9 rounded-xl bg-gray-200/70 dark:bg-[#181B22]" />
                    </div>
                  </td>
      ...
      {!loading && users.length > 0 && (
        <div className="border-t border-gray-100 dark:border-[rgba(255,255,255,0.06)] bg-[#FFEFDD]/30 dark:bg-[#181B22] px-6 py-3.5 flex items-center justify-between text-xs text-gray-500 dark:text-[#8A8378]">
          <span>
