function UserStatCard({ title, value, icon,className = "" }) {
  return (
    <div className="flex items-center justify-between p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#12141A] border border-gray-100/80 dark:border-0 shadow-sm transition-all hover:shadow-md">
      {/* Left side: Label + Value */}
      <div className="min-w-0 pr-3">
        <p className={`text-xs sm:text-[16px] font-medium text-[#E8B58F] dark:text-[#E8B58F] truncate ${className}`}>
          {title}
        </p>
