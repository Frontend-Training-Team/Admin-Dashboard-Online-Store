...
function TableSkeleton({ rows = 5 }) {
  return (
    <div className="w-full p-6 rounded-2xl border border-brand-200/60 dark:border-[rgba(255,255,255,0.06)] bg-surface-cardLight dark:bg-[#12141A] shadow-sm space-y-4">
